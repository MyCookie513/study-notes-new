...
<table width="509" height="352" border="0" align="center" cellpadding="0" cellspacing="0" background="img/bg.gif">
  <tr>
    <td height="54">&nbsp;</td>
  </tr>
  <tr>
    ...
    <table width="100%" height="250" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="33%"><img src="img/checkBt.jpg" width="104" height="23" style="cursor:hand;" onClick="checkUser(form1.username);"></td>
      </tr>
      <tr>
      ...
      <tr>
        <td>&nbsp;</td>
        <td colspan="2"><input type="image" name="imageField" src="img/registerBt.jpg"></td>
      </tr>
    </table>
	</div>
	</td>
