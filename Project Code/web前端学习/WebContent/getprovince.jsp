...
function getCity(selProvince){
	var loader=new net.AjaxRequest(encodeURIComponent("ZoneServlet?action=getCity&parProvince="+selProvince+"&nocache="+new Date().getTime()),deal_getCity,onerror,"GET");
}
