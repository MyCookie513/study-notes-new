...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-57" data-genuitec-path="/ArtFire/WebRoot/login.jsp">
	<div
		...
		<div id="loginbox">
			<h1 style="color: red;font-size: 60px;font-weight: normal;font-family: 华文行楷";>壁炉网络管理</h1>
			
			<form action="loginAction" method="post" name="loginForm" id="loginForm">
				...
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							...
							</span><input type="text" name="username" id="idmun"
	...
	<div id="templatemo_banner_slide" class="container_wapper">
		<div class="camera_wrap camera_emboss" id="camera_slide">
			...
			<div data-src="login/images/banner_slide_06.jpg"></div>
		</div>
	</div>
	<script type="text/javascript">
		function add() {
