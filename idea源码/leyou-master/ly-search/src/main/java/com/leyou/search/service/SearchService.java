...
public class SearchService {
     ...
     *
     * 搜索:   key  ,  filter
     * 分页查询： page ，page_size , sortBy ： 排序字段 , descending : 是否降序
     *
     *
     *
     * 选择好一个分类的时候
     * @param searchRequest   搜索请求的实体对象；
     * @return
     */
