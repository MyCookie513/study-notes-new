...
public abstract class AbstractQueuedSynchronizer_new
...
/**
    ...
    protected AbstractQueuedSynchronizer_new() { }
...
/**
        ...
        Node(Thread thread, int waitStatus) { // Used by Conditio
...
/**
    ...
    private  Node addWaiter(java.util.concurrent.locks.AbstractQueuedSynchronizer.Node mode) {
...
/**
    ...
    private static boolean shouldParkAfterFailedAcquire(java.util.concurrent.locks.AbstractQueuedSynchronizer.Node pred,  Node node) {
...
/**
    ...
    private void doAcquireInterruptibly(int arg)
        ...
        final  Node node = addWaiter(java.util.concurrent.locks.AbstractQueuedSynchronizer.Node.EXCLUSIVE);
        boolean failed = true;
        try {
            for (;;) {
                final  Node p = node.predecessor();
...
/**
    ...
    private void doAcquireShared(int arg) {
        final  Node node = addWaiter(java.util.concurrent.locks.AbstractQueuedSynchronizer.Node.SHARED);
        boolean failed = true;
        try {
            boolean interrupted = false;
            for (;;) {
